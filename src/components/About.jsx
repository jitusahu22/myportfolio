...
export default function About() {
  return (
    <section
      id="about"
      className="py-20 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 text-gray-800 dark:text-white"
    >
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center px-6">
        ...
        <motion.img
          ...
          viewport={{ once: true }}
          className="rounded-2xl shadow-xl border-4 border-indigo-500 w-full max-w-sm mx-auto"
        />
